...
class MyWindow(wx.Frame):
    def __init__(self, parent, title):
        super(MyWindow, self).__init__(parent, title = title, size = (320, 250))
        ...
        self.t4 = wx.TextCtrl(panel, value = "ReadOnly", style = wx.TE_READONLY | wx.TE_CENTER)
